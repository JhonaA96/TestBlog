...
@section('content')
    <h2 class="text-center mb-5">Crea tu blog</h2>

    <div class="row justify-content-center mt-5">
        <div class="col-md-8">

        <!-- Creación del formulario -->
        <form action="{{route ('Blog.Store')}}" enctype="multipart/form-data" method="post" novalidate>
                @csrf
                 <!-- Titulo del Blog -->
                ...
                <!-- Guardar Blog -->
                <div class="form-group mt-3">
                    <input type="submit" class="btn btn-primary" value="Agregar Blog">
